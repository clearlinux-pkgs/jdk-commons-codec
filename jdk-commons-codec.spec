...
License  : Apache-2.0
Requires: jdk-commons-codec-data
...
%package data
Summary: data components for the jdk-commons-codec package.
Group: Data

%description data
data components for the jdk-commons-codec package.


%prep
%setup -q -n commons-codec-1.10-src

python3 /usr/share/java-utils/mvn_file.py : commons-codec apache-commons-codec
python3 /usr/share/java-utils/mvn_alias.py : commons-codec:commons-codec
